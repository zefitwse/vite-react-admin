...
import AuthPicCom from "@/components/SilderAuthCom";
    ...
    <div className="login-container">
      <div className="login-page">
        <div className="backup">
          <Card className="login-card login-card-left" bordered={false}>
            <div>
              <svg
                className="login-svg"
              ...
              >
                ...
                <g>
                  ...
                  <g>
                    <path
                      id="uuid-00bc58e7-734f-4d7c-a085-03c0cd267642-40"
                  ...
                  />
                  <path
                    id="uuid-ece83039-1aa0-468e-a846-e0cb6ecd6032-41"
            ...
            >
              ...
              <Form.Item className="login-register">
                <>
                  ...
                  <div>
                    <Button className="login-form-button">立即注册</Button>
                  </div>
                </>
              </Form.Item>
            </Form>
